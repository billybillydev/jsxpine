...
import { themeSelectorData } from "./data/theme-selector.data";
import { themeToggleData } from "./data/theme-toggle.data";
...
Alpine.data("themeSelector", themeSelectorData);
Alpine.data("themeToggle", themeToggleData);
