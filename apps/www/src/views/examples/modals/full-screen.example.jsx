		...
		<Modal>
			...
			<ModalContent class={"bg-background"} type="full-screen">
				<div class="relative top-0 bottom-0 right-0 flex-shrink-0 hidden w-1/3 overflow-hidden bg-cover lg:block">
					...
					>
						<svg
							class="w-auto h-4 text-white fill-current lg:h-5"
							viewBox="0 0 355 99"
						...
						<span class="flex opacity-90 group-hover:scale-150 group-hover:opacity-100 items-center h-full group-hover:-rotate-6 ease-out duration-500 px-0.5 py-px ml-2 -translate-x-px text-[0.6rem] font-bold leading-none border-[2px] rounded border-white -translate-y-px">
							UI
						</span>
					</a>
					<div class="absolute inset-0 z-20 w-full h-full opacity-70 bg-gradient-to-t from-black"></div>
					<img
						src="https://cdn.devdojo.com/images/may2023/pines-bg-1.png"
						class="z-10 object-cover w-full h-full"
					/>
				</div>
				<div class="relative flex items-center justify-center w-full max-w-sm mx-auto lg:mb-0">
					<div>
