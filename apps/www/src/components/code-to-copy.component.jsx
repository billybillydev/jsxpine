...
/**
 * @param {import("$common/props").HTMLTagWithChildren<{ lang: import("$components/code-viewer.component").CodeLanguage; text?: string }>} props
 */
export function CodeToCopy({ children, class: className, lang, text }) {
	return (
		<section
			x-data="codeToCopy"
			class={clsx(
