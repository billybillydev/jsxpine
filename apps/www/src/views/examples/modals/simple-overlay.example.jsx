import { Modal, ModalTrigger, ModalContent } from "$components/modal.component";

export function SimpleLightOverlayModalExample() {
	return (
		<Modal>
			<ModalTrigger text="Open Overlay Light Modal" />
			<ModalContent overlay="light">
				<div class="relative flex flex-wrap bg-slate-700 text-white items-center w-full h-full p-2 md:p-8 rounded-lg">
					<div class="relative w-full max-w-sm mx-auto lg:mb-0">
						...
						<p class="px-8 mt-1 text-sm text-center">
